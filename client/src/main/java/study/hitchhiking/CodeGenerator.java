...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/client/src/main/java");//设置代码生成路径
        ...
        //设置自动填充配置
        TableFill gmt_create = new TableFill("createtime", FieldFill.INSERT);
        TableFill gmt_modified = new TableFill("updatetime", FieldFill.INSERT_UPDATE);
